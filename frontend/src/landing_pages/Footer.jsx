...
export default function Footer(){
    return (
        <footer style={{backgroundColor:"rgb(250,250,250)",color:"whitesmoke"}}>
    <div class="container border-top bg-color-tertary">
        <div class="row mt-4">
                <div class="col ">
                ...
                <div className="row-social d-flex">
                    <div className="col"><i class="fa-brands fa-x-twitter"></i></div>
                    <div className="col"><i class="fa-brands fa-square-facebook"></i></div>
                    <div className="col"><i class="fa-brands fa-instagram"></i></div>
                    <div className="col"><i class="fa-brands fa-linkedin-in"></i></div>
                    <hr/>
                    <div className="col"><i class="fa-brands fa-youtube"></i></div>
                    <div className="col"><i class="fa-brands fa-whatsapp"></i></div>
                    <div className="col"><i class="fa-brands fa-telegram"></i></div>
                </div>
                </div>
            ...
            <div class="col">
                ...
                <ul style={{listStyle:"none"}}>
                    <p className="nav-head">Upcoming IPOs</p>
        ...
        <p>Attention investors: Stock brokers can accept securities as margins from clients only by way of pledge in the depository system w.e.f September 01, 2020. 2) Update your e-mail and phone number with your stock broker / depository participant and receive OTP directly from depository on your e-mail and/or mobile number to create pledge. 3) Check your securities / MF / bonds in the consolidated account statement issued by NSDL/CDSL every month.</p>
        ...
        <div>
            <ul style={{listStyle:"none"}} className="d-flex text-align-center justify-content-center gap-4 ">
                <li>NSE</li>
                <li>BSE</li>
                <li>MCX</li>
                ...
                <li>Disclosure For investor's attention </li>
